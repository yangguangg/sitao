define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'ya_bucket_report/index' + location.search,
                    // add_url: 'ya_bucket_report/add',
                    // edit_url: 'ya_bucket_report/edit',
                    // del_url: 'ya_bucket_report/del',
                    // multi_url: 'ya_bucket_report/multi',
                    // import_url: 'ya_bucket_report/import',
                    table: 'ya_bucket_report',
                }
            });
