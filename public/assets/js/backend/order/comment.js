define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'order/comment/index' + location.search,
                    // add_url: 'order/comment/add',
                    // edit_url: 'order/comment/edit',
                    del_url: 'order/comment/del',
                    // multi_url: 'order/comment/multi',
                    // import_url: 'order/comment/import',
                    table: 'user_comment',
                }
            });
        ...
        recyclebin: function () {
            ...
            // 初始化表格
            table.bootstrapTable({
                url: 'order/comment/recyclebin' + location.search,
                pk: 'id',
                sortName: 'id',
                columns: [
                    [
